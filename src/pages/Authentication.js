...
export default function Authentication() {
    ...
    return (
        <div className="bg-blue-500 text-white flex flex-column min-h-screen">
            ...
            <p className="text-xs sm:text-sm pt-4 mb-2 text-center w-full">{`Copyright © 2019-2025 ${APP_NAME}`} </p>
        </div>
    );
}
