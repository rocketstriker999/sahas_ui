      ...
      <div className="flex flex-column h-full overflow-hidden">
        <div className="bg-blue-800 shadow-3 text-white flex align-items-center gap-3 p-2">
          <div className="w-8 flex-1">
            <p className={`${TITLE_TEXT} m-0 font-semibold`}>
              Welcome To Sahas Smart Studies
            </p>
            {isDevelopmentBuild && (
              <div
                className={`${TEXT_SIZE_SMALL} mt-1 bg-blue-800 text-white white-space-nowrap text-overflow-ellipsis overflow-hidden`}
              >
          ...
          <HasRequiredAuthority
            requiredAuthority={AUTHORITIES.MANAGE_DASHBOARD_DIALOG}
          >
            <i
