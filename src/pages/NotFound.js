...
export default function NotFound() {
    return (
        <div className="flex flex-column align-items-center justify-content-center min-h-screen p-2 text-center">
            ...
            <p className={`${TEXT_NORMAL} font-bold`}>OOPS , Resource Not Found !</p>
            <p className={`${TEXT_SMALL} text-color-secondary`}>We Didn't Find the Resource/Page You Are Looking For</p>
        </div>
    );
}
