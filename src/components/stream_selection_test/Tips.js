...
const tips = [
    ...
    },
    {
        ...
        points: ["Never select stream based on what others say.", "Focus more on what your inner self likes and matches with."],
    },
    {
    ...
    },
    {
        ...
        points: ["Choose a stream where you can study well and also grow through activities, enjoyment, and social/family bonding."],
    },
    {
        title: "Marks are important, but not everything",
        points: ["Along with marks, focus on knowledge, happiness in your stream, and happiness in life."],
    },
];
    ...
    return (
        <div className="flex-1 flex flex-column overflow-y-scroll p-2 md:p-3">
            <div className="surface-card border-1 surface-border border-round-xl p-3 md:p-4">
                ...
                <p className={`m-0 mb-3 text-color-secondary line-height-3 ${TEXT_SMALL}`}>Read these tips carefully before finalizing your stream decision.</p>
