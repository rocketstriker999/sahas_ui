        ...
        <div className="my-2 pl-2 py-2 border-round border-1 border-gray-300 relative overflow-hidden ">
            <div className=" flex  align-items-center">
                ...
                <div className="flex-1 flex flex-column gap-2 py-2">
                    <h2 className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold p-0 m-0">
                        #{id} - {name}
                    </h2>
                    <div className="flex align-items-center gap-2 text-sm sm:text-base md:text-lg lg:text-xl">
            ...
            <p className="absolute top-0 right-0 m-0 p-2 text-xs sm:text-base bg-orange-500 shadow-3 text-white font-semibold" style={{ borderBottomLeftRadius: "6px" }}>
                View More
            </p>
        </div>
    );
