...
export default function Users() {
            ...
            requestAPI({
                ...
                onResponseReceieved: (filters, responseCode) => {
                    if (filters && responseCode === 200) {
                        return setFilters([
                            { title: "Roles", key: "roles", options: roles, type: "MULTI_SELECT" },
                            { title: "Enrolled Courses", key: "courses", options: courses, type: "MULTI_SELECT" },
                            { title: "Enrollment Branches", key: "branches", options: branches, type: "MULTI_SELECT" },
    ...
    }, [branches, courses, filters, requestAPI, roles]);
            ...
            <div className="flex flex-column h-full overflow-hidden">
                <HasRequiredAuthority requiredAuthority={AUTHORITIES.MANAGE_OTHER_USERS}>
                    <div className="flex align-items-center p-2 gap-1">
                        ...
                        />
                        {users?.recordsCount > 0 && <Download entity="users" searchQuery={searchQuery} />}
                    </div>
